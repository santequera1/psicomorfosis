...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Una plataforma para toda tu práctica clínica: pacientes, agenda, historia clínica, documentos, psicometría y seguimiento en un solo lugar." },
      ...
      { property: "og:image:alt", content: "Psicomorfosis — Una plataforma para toda tu práctica clínica." },
