...
(function(){
  try {
    ...
    var FORCE_LIGHT_PATHS = ['/inicio', '/inicio2', '/nathaly-ferrer'];
  ...
  try {
    ...
    var publicPaths = ['/login', '/p/login', '/privacidad', '/terminos', '/inicio', '/inicio2', '/nathaly-ferrer'];
